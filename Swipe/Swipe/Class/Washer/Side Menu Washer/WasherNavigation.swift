...
class WasherNavigation: ENSideMenuNavigationController, ENSideMenuDelegate {
    ...
    func setLayout() {
        ...
        let VC = sideMenuSB.instantiateViewController(withIdentifier: "SideMenu1VC") as! SideMenu1VC
